...
public class Order1 extends AppCompatActivity {
    ...
    private String[] name = new String[]{"招牌火雞肉飯 $55","蛋花湯 $25","雞片飯 $40","滷蛋 $15"};
    private int[] image = new int[]{R.drawable.fire,R.drawable.eggf,R.drawable.firep,R.drawable.eggl};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener((item) -> {
            ...
            switch(item.getItemId()){
                case R.id.car:
                    ...
                    Intent last1 = new Intent();
                    last1.setClass(this,Last1.class);
                    startActivity(last1);
                    break;
                case R.id.logout:
        ...
        lvShow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(Order1.this,"已加入購物車: "+name[i],Toast.LENGTH_SHORT).show();
            }
        });
    }
}
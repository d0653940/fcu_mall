...
public class Order0 extends AppCompatActivity {

    private ListView lvShow;
    private String[] name = new String[]{"滷肉飯 $45","貢丸湯 $20","陽春麵(乾/湯) $35","小菜 $10"};
    private int[] image = new int[]{R.drawable.pork,R.drawable.soup,R.drawable.noodle,R.drawable.lil};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener((item) -> {
            ...
            switch(item.getItemId()){
                case R.id.car:
                    Toast.makeText(this,"前往購物清單",Toast.LENGTH_SHORT).show();
                    Intent intentGo = new Intent();
                    intentGo.setClass(this, Last0.class);
        ...
        lvShow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(Order0.this,"已加入購物車: "+name[i],Toast.LENGTH_SHORT).show();
            }
        });
    }
}